          ...
          <div className="space-y-4 rounded-md shadow-sm">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  <option value="ROLE_USER" className="bg-slate-900 text-slate-100">Standard User</option>
                  <option value="ROLE_ADMIN" className="bg-slate-900 text-slate-100">Administrator</option>
                </select>
              </div>
            </div>
          </div>
